...
function scene:create( event )
	...
	local meta = display.newImageRect("imagenes/metas/1_pilar_meta2.png",320,1000)
...
function irEscenaPilares()
	...
	scrollView = nil
	composer.removeScene('p1_d2_m2',false) 
...
function funcion_flecha_adelante()
	...
	scrollView = nil
	composer.removeScene('p1_d2_m2',false) 
	composer.gotoScene("p1_d2_m3", { effect = "fade", time = 100 } )
	end 
end
