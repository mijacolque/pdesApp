...
local meta = display.newImageRect('imagenes/metas/3_pilar_meta1.png',320,1000) 
...
function irEscenaPilares()
	...
	composer.removeScene('3_pilar_meta1',false) 
...
function funcion_flecha_adelante() 
	...
	composer.gotoScene('3_pilar_meta2', { effect = 'fade', time = 100 } ) 
