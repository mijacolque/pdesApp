...
local meta = display.newImageRect('imagenes/metas/2_pilar_meta5.png',320,1000) 
...
function irEscenaPilares()
	...
	composer.removeScene('2_pilar_meta5',false) 
  ...
  local function onKeyEvent( event )
    ...
    if (event.phase == "up" and (event.keyName=="back" or event.keyName=="menu")) then
            ...
            elseif keyname == "back" then
				...
				scrollView:removeSelf() 
				scrollView = nil 
				composer.removeScene("12_pilar_meta5",false) 
				composer.gotoScene("pilares", { effect = "fade", time = 100 } )
				end 
