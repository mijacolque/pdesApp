...
local meta = display.newImageRect('imagenes/metas/1_pilar_meta6.png',320,1000) 
...
function irEscenaPilares()
	...
	composer.removeScene('1_pilar_meta6',false) 
...
function funcion_flecha_atras() 
	...
	composer.gotoScene('1_pilar_meta5', { effect = 'fade', time = 100 } ) 
