...
local meta = display.newImageRect('imagenes/metas/4_pilar_meta5.png',320,1000) 
...
function irEscenaPilares()
	...
	composer.removeScene('4_pilar_meta5',false) 
...
function funcion_flecha_adelante() 
	...
	composer.gotoScene('4_pilar_meta6', { effect = 'fade', time = 100 } ) 
