...
local meta = display.newImageRect('imagenes/metas/6_pilar_meta4.png',320,1000) 
...
function irEscenaPilares()
	...
	composer.removeScene('6_pilar_meta4',false) 
...
function funcion_flecha_adelante() 
	...
	composer.gotoScene('6_pilar_meta5', { effect = 'fade', time = 100 } ) 
