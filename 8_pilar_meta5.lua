...
local meta = display.newImageRect('imagenes/metas/8_pilar_meta5.png',320,1000) 
...
function irEscenaPilares()
	...
	composer.removeScene('8_pilar_meta5',false) 
...
function funcion_flecha_atras() 
	...
	composer.gotoScene('8_pilar_meta2', { effect = 'fade', time = 100 } ) 
