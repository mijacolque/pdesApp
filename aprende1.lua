...
composer.gotoScene( "aprende2", { effect = "slideLeft", time = 600 } )

end

local function irEscenaAprende1()

composer.gotoScene( "principal", { effect = "slideRight", time = 600 } )
...
function scene:create( event )
	...
	local aprendePantalla1 = display.newImageRect("src/aprende/aprende1.jpg",320,570)
	...
	local punto1_aprende = display.newImageRect("src/aprende/punto1_aprende.png",78,30)
	...
	invisibleDerecha:addEventListener("touch",irEscenaAprende2)
