...
local meta = display.newImageRect('imagenes/metas/6_pilar_meta11.png',320,1000) 
...
function irEscenaPilares()
	...
	composer.removeScene('6_pilar_meta11',false) 
...
function funcion_flecha_adelante() 
	...
	composer.gotoScene('6_pilar_meta12', { effect = 'fade', time = 100 } ) 
...
function funcion_flecha_atras() 
	...
	composer.gotoScene('6_pilar_meta10', { effect = 'fade', time = 100 } ) 
