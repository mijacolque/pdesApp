...
local meta = display.newImageRect('imagenes/metas/3_pilar_meta5.png',320,1000) 
...
function irEscenaPilares()
	...
	composer.removeScene('3_pilar_meta5',false) 
...
function funcion_flecha_adelante() 
	...
	composer.gotoScene('3_pilar_meta6', { effect = 'fade', time = 100 } ) 
