...
local meta = display.newImageRect('imagenes/metas/9_pilar_meta1.png',320,1000) 
...
function irEscenaPilares()
	...
	composer.removeScene('9_pilar_meta1',false) 
...
function funcion_flecha_adelante() 
	...
	composer.gotoScene('9_pilar_meta2', { effect = 'fade', time = 100 } ) 
