...
local meta = display.newImageRect('imagenes/metas/10_pilar_meta1.png',320,1000) 
...
function irEscenaPilares()
	...
	composer.removeScene('10_pilar_meta1',false) 
...
function funcion_flecha_adelante() 
	...
	composer.gotoScene('10_pilar_meta4', { effect = 'fade', time = 100 } ) 
