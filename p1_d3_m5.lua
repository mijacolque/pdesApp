...
function scene:create( event )
	...
	local meta = display.newImageRect("imagenes/metas/1_pilar_meta5.png",320,1000)
...
function irEscenaPilares()
	...
	scrollView = nil
	composer.removeScene('p1_d3_m5',false) 
...
function funcion_flecha_adelante()
	...
	scrollView = nil
	composer.removeScene('p1_d3_m5',false) 
	composer.gotoScene("p1_d3_m6", { effect = "fade", time = 100 } )
	end 
end
...
function funcion_flecha_atras()
	...
	scrollView = nil
	composer.removeScene('p1_d3_m5',false) 
	composer.gotoScene("p1_d3_m4", { effect = "fade", time = 100 } )
	end 
end
